...
export const catalogProductData = [
      ...
      categories: [
         {
            ...
            filterCharacteristicsKey: 'storage',
            subCategory: [
               { id: 1, title: 8 },
               { id: 2, title: 16 },
               { id: 3, title: 32 },
   ...
   },
   {
      ...
      categories: [
         ...
         {
            id: 8,
            type: 'Диагональ экрана',
            filterCharacteristicsKey: 'screenDiagonal',
            subCategory: [
               { id: 1, title: '0 - 2 дюйма' },
               { id: 2, title: '3 - 5 дюймов' },
               { id: 4, title: '6 - 8 дюймов' },
               { id: 5, title: '9 - 11 дюймов' },
               { id: 6, title: '12 - 15 дюймов' },
            ],
         },
         {
            id: 9,
            type: 'Емкость аккумулятора',
            filterCharacteristicsKey: 'batteryCapacity',
            subCategory: [
               { id: 1, title: '0 - 2399 мА/ч' },
               { id: 2, title: '2400 - 4799 мА/ч' },
               { id: 4, title: '4800 - 7199 мА/ч' },
   ...
   },
   {
      ...
      categories: [
         ...
         {
            id: 7,
            type: 'Материал ремешка',
            filterCharacteristicsKey: 'strapMaterial',
            subCategory: [
               { id: 1, title: 'Силикон' },
               { id: 2, title: 'Кожа' },
               { id: 4, title: 'Резина' },
         ...
         },
         {
            ...
            filterCharacteristicsKey: 'caseMaterial',
            subCategory: [
         ...
         },
         {
            ...
            filterCharacteristicsKey: 'displayDiagonal',
            subCategory: [
               { id: 1, title: 1.2 },
               { id: 2, title: 1.22 },
               { id: 3, title: 1.3 },
